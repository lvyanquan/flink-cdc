 ...
 */
class KafkaValueOnlySchemaAwareDeserializationSchemaWrapper<T>
        implements KafkaRecordSchemaAwareDeserializationSchema<T> {
    private static final long serialVersionUID = 1L;
    private final SchemaAwareDeserializationSchema<T> deserializationSchema;

    KafkaValueOnlySchemaAwareDeserializationSchemaWrapper(
            SchemaAwareDeserializationSchema<T> deserializationSchema) {
