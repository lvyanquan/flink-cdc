 ...
 */
public class PipelineUpsertKafkaRecordSerializationSchema
    ...
    PipelineUpsertKafkaRecordSerializationSchema(
        ...
        this.keySerialization = checkNotNull(keySerialization);
    ...
    public ProducerRecord<byte[], byte[]> serialize(
        ...
        return new ProducerRecord<>(
                topic, null, null, keySerialized, valueSerialized, recordHeaders);
    }
