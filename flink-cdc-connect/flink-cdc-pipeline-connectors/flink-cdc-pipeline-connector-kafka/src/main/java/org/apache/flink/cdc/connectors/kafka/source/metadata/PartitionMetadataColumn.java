...
/** A {@link SupportedMetadataColumn} for partition. */
public class PartitionMetadataColumn implements SupportedMetadataColumn {
    ...
    public Object read(Map<String, String> metadata) {
        if (metadata.containsKey(getName())) {
            return Integer.parseInt(metadata.get(getName()));
        }
