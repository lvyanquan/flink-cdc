...
public interface KafkaRecordSchemaAwareDeserializationSchema<T>
    ...
    static <V> KafkaRecordSchemaAwareDeserializationSchema<V> valueOnly(
            SchemaAwareDeserializationSchema<V> valueDeserializationSchema) {
        return new KafkaValueOnlySchemaAwareDeserializationSchemaWrapper<>(
