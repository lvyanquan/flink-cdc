...
/**
 * Time formats and timestamp formats respecting the SQL specification, inspiring by
...
public class TimeFormats {
    ...
    public static final DateTimeFormatter SQL_TIMESTAMP_WITH_TIMEZONE_FORMAT =
            new DateTimeFormatterBuilder()
                    .append(DateTimeFormatter.ISO_LOCAL_DATE)
                    .appendLiteral(' ')
                    .append(SQL_TIME_FORMAT)
