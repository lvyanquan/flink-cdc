...
/**
 * The {@link SourceEvent} that the {@link MySqlHybridSplitAssigner} in {@link
 * MySqlSourceEnumerator} sends to {@link MySqlSourceReader} to notify the reader to request splits.
 */
public class TriggerSplitRequestEvent implements SourceEvent {

    private static final long serialVersionUID = 1L;

    public TriggerSplitRequestEvent() {}
}
