...
public class EventDeserializer {
    ...
    public final EventHeaderDeserializer eventHeaderDeserializer;
    ...
    private void registerDefaultEventDataDeserializers() {
        eventDataDeserializers.put(
                EventType.FORMAT_DESCRIPTION, new FormatDescriptionEventDataDeserializer());
        ...
        eventDataDeserializers.put(
                EventType.WRITE_ROWS, new WriteRowsEventDataDeserializer(tableMapEventByTableId));
        eventDataDeserializers.put(
                EventType.UPDATE_ROWS, new UpdateRowsEventDataDeserializer(tableMapEventByTableId));
        eventDataDeserializers.put(
                EventType.DELETE_ROWS, new DeleteRowsEventDataDeserializer(tableMapEventByTableId));
        eventDataDeserializers.put(
        ...
        eventDataDeserializers.put(
                EventType.ANNOTATE_ROWS, new AnnotateRowsEventDataDeserializer());
        eventDataDeserializers.put(EventType.MARIADB_GTID, new MariadbGtidEventDataDeserializer());
        eventDataDeserializers.put(
                EventType.MARIADB_GTID_LIST, new MariadbGtidListEventDataDeserializer());
        eventDataDeserializers.put(
                EventType.TRANSACTION_PAYLOAD, new TransactionPayloadEventDataDeserializer());
    }

    public void setEventDataDeserializer(
    ...
    private void ensureCompatibility(EventDataDeserializer eventDataDeserializer) {
        if (eventDataDeserializer instanceof AbstractRowsEventDataDeserializer) {
            ...
            if (compatibilitySet.contains(CompatibilityMode.INVALID_DATE_AND_TIME_AS_MIN_VALUE)) {
                if (!deserializeDateAndTimeAsLong) {
                    throw new IllegalArgumentException(
                            "INVALID_DATE_AND_TIME_AS_MIN_VALUE requires "
                                    + "DATE_AND_TIME_AS_LONG or DATE_AND_TIME_AS_LONG_MICRO");
                }
    ...
    public EventData deserializeFormatDescriptionEventData(
            ...
            try {
                ...
                if (eventData instanceof EventDataWrapper) {
                    ...
                    formatDescriptionEvent =
                            (FormatDescriptionEventData) eventDataWrapper.getInternal();
    ...
    public EventData deserializeTransactionPayloadEventData(
            ByteArrayInputStream inputStream, EventHeader eventHeader) throws IOException {
        EventDataDeserializer eventDataDeserializer =
        ...
        TransactionPayloadEventData transactionPayloadEventData =
                (TransactionPayloadEventData) eventData;

        /**
         * Handling for TABLE_MAP events withing the transaction payload event. This is to ensure
         * that for the table map events within the transaction payload, the target table id and the
         * event gets added to the tableMapEventByTableId map. This is map is later used while
         * deserializing rows.
         */
    ...
    public EventData deserializeTableMapEventData(
            ByteArrayInputStream inputStream, EventHeader eventHeader) throws IOException {
        EventDataDeserializer eventDataDeserializer =
                tableMapEventDataDeserializer != null
                        ? tableMapEventDataDeserializer
    ...
    public EventData deserializeEventData(
    ...
    public enum CompatibilityMode {
         ...
         * (number of milliseconds since the epoch (00:00:00 Coordinated Universal Time (UTC),
         * Thursday, 1 January 1970, not counting leap seconds)) (instead of
         * java.util.Date/java.sql.Timestamp/java.sql.Date/new java.sql.Time).
         *
         * <p>This option is going to be enabled by default starting from
         * mysql-binlog-connector-java@1.0.0.
         */
        DATE_AND_TIME_AS_LONG,
        /**
         * Same as {@link CompatibilityMode#DATE_AND_TIME_AS_LONG} but values are returned in
         * microseconds.
         */
        DATE_AND_TIME_AS_LONG_MICRO,
        /**
         * Return 0 instead of null if year/month/day is 0. Affects
         * DATETIME/DATETIME_V2/DATE/TIME/TIME_V2.
         */
        INVALID_DATE_AND_TIME_AS_ZERO,
        /**
         * Return -1 instead of null if year/month/day is 0. Affects
         * DATETIME/DATETIME_V2/DATE/TIME/TIME_V2.
         *
         * @deprecated
         */
        ...
        /**
         * Return Long.MIN_VALUE instead of null if year/month/day is 0. Affects
         * DATETIME/DATETIME_V2/DATE/TIME/TIME_V2.
         */
    ...
    /**
     * Enwraps internal {@link EventData} if custom {@link EventDataDeserializer} is provided (for
     * internally used events only).
     */
