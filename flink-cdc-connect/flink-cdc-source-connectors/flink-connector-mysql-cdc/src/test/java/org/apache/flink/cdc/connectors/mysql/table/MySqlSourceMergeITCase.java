...
public class MySqlSourceMergeITCase extends MySqlSourceTestBase {
    ...
    public boolean operatorChain;

    @Parameterized.Parameters(
            name = "debeziumProperties: {0}, enableSourceMerge: {1}, operatorChain: {2}")
    public static Object[] parameters() {
        return new Object[][] {
            ...
            new Object[] {new HashMap<>(), false, true},
            new Object[] {new HashMap<>(), true, true},
            new Object[] {new HashMap<>(), true, false},
        };
    }
    ...
    public void testMergeSourceInTwoPipelines() throws Exception {
        tEnv.getConfig()
                ...
                .set(OPERATOR_CHAINING, operatorChain);
