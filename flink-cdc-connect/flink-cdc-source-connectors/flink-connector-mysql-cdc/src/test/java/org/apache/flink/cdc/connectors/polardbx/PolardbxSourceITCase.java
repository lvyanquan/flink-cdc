...
public class PolardbxSourceITCase extends PolardbxSourceTestBase {
    ...
    private static final String DATABASE = "cdc_s_" + getRandomSuffix();

    @BeforeClass
    public static void beforeClass() throws InterruptedException {
        initializePolardbxTables(DDL_FILE, DATABASE, null);
    }
        ...
        String[] expectedSnapshotData =
                new String[] {
                    "+I[100001, 127, 255, 32767, 65535, 8388607, 16777215, 2147483647, 4294967295, 2147483647, "
                            ...
                            + "b], {\"key1\":\"value1\",\"key2\":\"value2\",\"num1\":16708304,\"num2\":16708305}, {\"coordinates\":[1,1],\"type\":\"Point\",\"srid\":0}, "
