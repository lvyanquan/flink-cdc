...
public class MongoDBTableFactoryTest {
    ...
    private static final boolean SCAN_FLATTEN_NESTED_COLUMNS_ENABLED_DEFAULT =
            SCAN_FLATTEN_NESTED_COLUMNS_ENABLED.defaultValue();
    ...
    public void testOptionalProperties() {
        ...
        options.put("scan.flatten-nested-columns.enabled", "true");
