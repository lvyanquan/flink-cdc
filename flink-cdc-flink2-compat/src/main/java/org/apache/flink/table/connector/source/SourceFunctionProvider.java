...
public interface SourceFunctionProvider
    ...
    static org.apache.flink.legacy.table.connector.source.SourceFunctionProvider of(
        ...
        return new org.apache.flink.legacy.table.connector.source.SourceFunctionProvider() {
    ...
    org.apache.flink.streaming.api.functions.source.SourceFunction<RowData> createSourceFunction();
}
